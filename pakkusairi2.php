...
if(isset($_POST['send_btn'])) {
    ...
    $tgl     = $_POST['date'];
    $msg     = $_POST['catatan'];
    $url      = "https://wa.me/6285775522863/?text=Halo saya $nama, ingin reservasi  *HOMESTAY PAK KUSAIRI* untuk tanggal $tgl. %0A *catatan* %0A $msg.%0A*FASILITAS*%0A 1. Wisata Coban Binangun.%0A 2. Area Selfi.%0A 3. Kolam Renang%0A 4. Area Kolam Terapi.%0A 5. Area Bermain Bambu.%0A 6. Area Santai. %0A*BENEFIT*%0A 1. Tiket Masuk.%0A 2. Welcome Snack. ";
